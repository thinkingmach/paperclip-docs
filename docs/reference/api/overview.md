...
seo_description: Reference for ThinkingMach's JSON control-plane API — companies, agents, issues, approvals, costs, routines, secrets, activity, and dashboard state.
---
