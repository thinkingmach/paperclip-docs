...
async function main() {
  ...
  const betaMetadata = { ...rootMetadata, title: "Welcome to the ThinkingMach hosted beta", description: markdownDescription(betaMarkdown), url: siteUrlForPath(options.siteUrl, options.basePath, "hosted-beta/"), page: betaPage };
